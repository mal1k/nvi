        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">New account
                    </li>
                </ol>
            </div>
        </div>
...
<div id="accounts-module">
    <create-account :roles="{{isset($roles) ? json_encode($roles) : json_encode('')}}"
        :editable_account="{{isset($editable_account) ? json_encode($editable_account) : json_encode('')}}">
    </create-account>
</div>
@endsection
