    ...
    <div class="content-header col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Securities
                    </li>
                    <li class="breadcrumb-item"><a href="/admin/securities/create">New security</a>
                    </li>
                </ol>
            </div>
        </div>
...
<div id="securities-module">
    <securities-list :roles="{{isset($securities) ? json_encode($securities) : json_encode('')}}"></securities-list>
</div>
@endsection
