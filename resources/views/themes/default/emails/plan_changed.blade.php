                    ...
                    <div
                        ...
                        <div
                            ...
                            <div
                                ...
                                style="font-size: 16px;"><strong>Great News {{$name}}</strong></span>
                                </p>
                                <p style="font-size: 14px; line-height: 26px;"><span
                                        style="font-size: 14px;">
                                        We wanted to show our appreciation to our loyal customers! So we decided to lower prices for all current customers who are using NVI!
                                    </span>
                                </p>
                                <p style="font-size: 14px; line-height: 26px;margin: 0;"><span
                                    style="font-size: 14px;">Your New {{ucfirst($plan->interval)}}ly Price: ${{$plan->min_price}}</span>
                                </p>
                                <p style="font-size: 14px; line-height: 26px;margin: 0;"><span
                                    style="font-size: 14px;">Your New Free Records: {{number_format($plan->free_records)}}</span>
                                </p>
                                <p style="font-size: 14px; line-height: 26px;margin: 0;"><span
                                    style="font-size: 14px;">Your New Price Per Record: ${{$plan->unit_price}}</span>
                                </p>
                        ...
                        <div
                            ...
                            <div
                                style="font-size: 12px; line-height: 14px; color: #132F40; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                <p style="font-size: 14px; line-height: 26px; margin: 0;"><span
                                        style="font-size: 14px;">Please contact us if you have any questions. We appreciate you as part of NVI's family.</span>
                                </p>
                        ...
                        <div
                            style="color:#132F40;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;padding-top:5px;padding-right:10px;padding-bottom:30px;padding-left:10px;">
                            <div
                                style="font-size: 12px; line-height: 18px; color: #132F40; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;">
