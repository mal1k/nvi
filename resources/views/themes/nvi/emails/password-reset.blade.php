                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    style="font-size: 16px;"><strong>{{$name}}</strong></span>
                                                    </p>
                                                    <p style="font-size: 14px; line-height: 26px; margin: 0;"><span
                                                            style="font-size: 16px;">You are receiving this email because we received a password reset request for your account.</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                style="color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;padding-top:25px;padding-right:10px;padding-bottom:30px;padding-left:10px; text-align: center">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 21px; margin: 0;">
                                                        This password reset link will expire in 24 hours.</p>
                                                    <p style="font-size: 14px; line-height: 21px; margin: 0;">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 12px; line-height: 21px; margin: 0;">
                                                        ...
                                                        <a href="{{url(config('app.url')).'/password/reset/'.$token}}">{{url(config('app.url')).'/password/reset/'.$token}}</a>    
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
