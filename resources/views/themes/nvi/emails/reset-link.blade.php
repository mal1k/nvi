                                        ...
                                        <div
                                            ...
                                            <div align="center" class="img-container center fixedwidth"
                                                ...
                                                <div style="font-size:1px;line-height:25px"> </div><img align="center"
                                                    ...
                                                    src="{{config('app.url').'/fe/images/logo.png'}}"
                                                    style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; clear: both; border: 0; height: auto; float: none; width: 100%; display: block;"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 26px; margin: 0;"><span
                                                            style="font-size: 22px;">Welcome to Hatton's daily project manager report system</strong></span>
                                                    </p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p style="font-size: 14px; line-height: 21px; margin: 0;">
                                                        In order to access the system, please click the Reset Password
                                                        button bellow to set your password.<br><br>
                                                        <b>Username/Email:</b> {{$user->email}}
                                                </div>
                                            </div>
                                            <div
                                                style="color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:150%;padding-top:5px;padding-right:10px;padding-bottom:30px;padding-left:10px; text-align: center">
                                                <a style="padding: 10px; background-color: border-color; color: #fff; text-decoration: none"
                                                    href="{{url(config('app.url').route('password.reset', $token, false))}}">Reset
                                                    password</a>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                    ...
                    <div style="background-color:#fdfdfd;">
                        <div class="block-grid two-up no-stack"
                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:border-color;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:#f3534d"><![endif]-->
                                <!--[if (mso)|(IE)]><td align="center" width="300" style="background-color:#f3534d;width:300px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 25px; padding-top:15px; padding-bottom:15px;"><![endif]-->
