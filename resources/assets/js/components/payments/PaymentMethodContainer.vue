                            ...
                            <div v-show="payment_methods.credit_card" :class="{'col-md-4' : (options && options.length == 3), 'col-md-6' : (options && options.length == 2),
                             'col-md-12' : (!options || options.length == 1)}">
                                <span style="padding: 10px">
                                    <input id="credit_card" type="radio" value="credit_card" name="payment_method" class="credit_card"
                                        checked>
...
export default {
    props: ['card_processor', 'client_key', 'api_id', 'description', 'options', 'payable_type', 'payable_id','save_method','amount','pay'],
    components: {
    ...
    mounted(){
        ...
        this.$nextTick(function(){
            ...
            $('#credit_card').on('ifChecked', function (event) {
                console.log(self.payment_method);
