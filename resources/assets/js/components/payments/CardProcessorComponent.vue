            ...
            <div class="col-xs-12 col-sm-12">
                ...
                <div class="row" style="margin-top: 10px">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input  v-mask="'##/####'" v-model="exp_date" type="text" class="form-control" :class="{'input-error-select' : error.exp_date}">
                        </div>
    ...
    export default {
        ...
        mounted(){
            ...
            this.$nextTick(function () {
                ...
                $('#recurring-payment-card').iCheck({
                    checkboxClass: 'icheckbox_square-red',
                    radioClass: 'iradio_square-red',
                });
                 $('#save-method-card').iCheck({
                    checkboxClass: 'icheckbox_square-red',
                    radioClass: 'iradio_square-red',
                });
