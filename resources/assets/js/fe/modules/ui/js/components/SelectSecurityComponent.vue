                    ...
                    <div class="col-12 text-center">
                        <strong>
                            <p style="font-size: 14px; color: #fff; margin-top: 15px; margin-bottom: 0px;">Important:
                                All activities are relative to the selected security below. Be sure to select the
                                appropriate security before make any simulation in order to avoid cross security
                                activities.</p>
                        </strong>
                    </div>
                </div>
        ...
        mounted() {
            ...
            this.$nextTick(function () {
                $("#select2-accounts").select2({
                    ...
                    background: "red",
                    background: "#000",
                    data: $.map(self.security, function (item) {
                        return {
                            id: item.id,
                            text: item.security_number,
                            type: '',
                            name: ''
                        ...
                        var e = "<div class='select2-result-repository clearfix'>\
                                    <div class='select2-result-repository__meta'>\
                                        <div class='select2-result-repository__title'>\
                                            <div style='font-size: 12px'>Security number</div>"
                                        + t.text + "</div>\
                                    </div>\
                                </div>";
                        return e;
