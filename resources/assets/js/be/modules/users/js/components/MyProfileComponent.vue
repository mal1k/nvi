            ...
            <div class="card-content">
                ...
                <div class="card-body" style="padding-top:0px;">
                    <ul class="nav nav-tabs mt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="base-transactions" data-toggle="tab" aria-controls="tab1" @click="goTab('billing')"
                                href="#transactions" aria-expanded="false"><i class="fa fa-money"></i>Billing</a>
                        </li>
                        <li class="nav-item" >
                            <a class="nav-link" id="base-payment-methods" data-toggle="tab" aria-controls="tab1" @click="goTab('payment_methods')"
                        ...
                        <div role="tabpanel" class="tab-pane active" id="general" aria-expanded="true" aria-labelledby="base-general">
                            <form class="form row card-body">
                                ...
                                <div class="form-group mb-1 col-sm-6 col-md-3">
                                    ...
                                    <br>
                                    <input v-model="address.state" type="text" class="form-control" id="state">
                                </div>
                                <div class="form-group mb-1 col-sm-6 col-md-3">
                                    <label for="country">Country</label>
                                    <br>
                                    <input v-model="address.country" type="text" class="form-control" id="country">
                                </div>
                            </form>
                            <form class="form row card-body">
                                <div class="form-group mb-1 col-sm-6 col-md-3">
                                    ...
                                    <br>
                                    <select v-model="user.account_type" class="form-control" id="account_type" style="font-size: 12px !important">
                               ...
                               <div class="form-group mb-1 col-sm-6 col-md-3">
                                    ...
                                    <br>
                                    <select v-model="user.investor" class="form-control" id="investor" style="font-size: 12px !important">
                            ...
                            <div class="row" v-if="showSubscription">
                                <div class="col-md-12">
...
<script>
    ...
    import SubscriptionDetailsComponent from '../../../../../../../js/be/modules/plans/js/components/subscriptions/SubscriptionDetailsComponent.vue'
    export default {
